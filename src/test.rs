...
#![cfg(test)]
extern crate std;  //standart create çekiyoruz
...
fn create_token_contract<'a>(
    e: &Env,
    admin: &Address,   //lifeTime belirli bir metodun yaşam döngüsünü belirler
...
fn test() {
    ...
    let sell_token_client = sell_token.0; // 0 dan başlat
    let sell_token_admin_client = sell_token.1; // 0 altında bir işlem olmamasını engelliyoruz
